...
###########################################################
# Data directories
fasta_directory = 'input/SEQUENCE_1000' + '.fasta'
prob_directory = 'input/SEQUENCE_1000' + '.prob'
###########################################################


# Get data from ".prob" file (Generated by VARNA)
data = toolbox.csv_reader(prob_directory,delimiter='\t')
...
data = toolbox.csv_reader(fasta_directory,delimiter='\n')
